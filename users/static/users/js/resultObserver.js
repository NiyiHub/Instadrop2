...
const parcelCoverHolding = document.querySelector(".parcel-cover");
const NameOptions = {
...
whitenHeader.observe(parcelCoverHolding);
// HEADER OBSERVER ENDS
...
function displayMenu(e)
{
    ...
    if(e.type == "click"){
        if(menuOptionSelected == ""){
            ...
            whitenHeader.unobserve(parcelCoverHolding);
            sublistNav.classList.remove("whitened");
            navlinks.forEach(link =>{
                link.classList.remove("blackened");
            });
